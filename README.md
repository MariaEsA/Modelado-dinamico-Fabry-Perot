...
* Analizar la interferencia múltiple mediante la función de Airy.
* Relacionar el resonador óptico con un oscilador armónico amortiguado.
...
Mediante ajustes angulares con un goniómetro se registraron patrones de interferencia y colapsos resonantes producidos por múltiples reflexiones dentro de la cavidad óptica.

Los resultados experimentales fueron posteriormente comparados con simulaciones computacionales desarrolladas en Python.
...
* El modelo diferencial permitió interpretar físicamente el sistema como un resonador amortiguado excitado externamente.
